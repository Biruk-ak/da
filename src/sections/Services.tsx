...
const services = [
  {
    title: "DA IT Solutions",
    description: "Empowering your operations with full stack development, SaaS design, managed IT services, and robust cybersecurity.",
    image: "/images/service-1.jpg",
    bgColor: "bg-lime",
  },
  {
    title: "DA Digital Marketing",
    description: "Strengthening your digital identity and audience engagement through strategic branding, social media management, and motion graphics.",
    image: "/images/service-2.jpg",
    bgColor: "bg-foreground",
  },
  {
    title: "Custom Software Development",
    description: "We build scalable, secure, and future ready digital solutions that drive meaningful transformation.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-xl">
            We deliver end-to-end digital solutions that drive real impact.
          </p>
        </ScrollReveal>
