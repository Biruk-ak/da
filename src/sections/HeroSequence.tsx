      ...
      <div className="hero-sequence-pinned h-screen w-full sticky top-0 overflow-hidden bg-background">
        ...
        <div ref={heroContentRef} className="absolute inset-0 z-20 flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:px-24 text-left pb-20 md:pb-0 pointer-events-none">
          <div className="max-w-sm sm:max-w-md md:max-w-xl lg:max-w-2xl pointer-events-auto">
            <h1 className="hero-title select-none w-full" style={{ perspective: "1500px" }}>
              <span className="font-moonwalk block text-[2rem] sm:text-[3rem] md:text-[4rem] lg:text-[5.5rem] xl:text-[6rem] text-foreground leading-[0.85] tracking-[0.05em] drop-shadow-xl hero-line">
                BOOST YOUR<br />EFFICIENCY
              </span>
            </h1>
            ...
            <div className="hero-subtitle-wrap mt-6 md:mt-8 pr-4 text-foreground/70">
              <p className="hero-subtitle text-sm lg:text-base leading-relaxed tracking-wide font-medium md:font-light">
                A forward thinking technology and digital solutions provider dedicated
                to helping organizations grow, adapt, and thrive in an increasingly digital world.
              </p>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 w-full z-30 flex gap-6 px-6 sm:px-12 md:px-16 lg:px-24 py-6 md:py-8 items-center bg-gradient-to-t from-background via-background/90 to-transparent border-t border-foreground/5 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3 sm:gap-4 ml-auto shrink-0 relative z-50">
            <a href="https://www.linkedin.com/company/digital-addis/" className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/20 flex items-center justify-center hover:bg-foreground hover:text-background transition-all duration-300 transform hover:scale-110 shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:shadow-[0_0_15px_rgba(255,255,255,0.05)] text-foreground"><span className="text-[10px] font-bold uppercase tracking-widest">in</span></a>
            <a href="https://www.instagram.com/digitaladdis?igsh=Mzl6aWxjZDZzczA5" className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/20 flex items-center justify-center hover:bg-foreground hover:text-background transition-all duration-300 transform hover:scale-110 shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:shadow-[0_0_15px_rgba(255,255,255,0.05)] text-foreground"><span className="text-[10px] font-bold uppercase tracking-widest">ig</span></a>
            <a href="https://www.tiktok.com/@digitaladdis?_r=1&_t=ZS-95aD78lO3ZU" className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/20 flex items-center justify-center hover:bg-foreground hover:text-background transition-all duration-300 transform hover:scale-110 shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:shadow-[0_0_15px_rgba(255,255,255,0.05)] text-foreground"><span className="text-[10px] font-bold uppercase tracking-widest">t</span></a>
            <a href="https://www.facebook.com/share/16EbG4ksLH/" className="w-10 h-10 rounded-full bg-foreground/5 border border-foreground/20 flex items-center justify-center hover:bg-foreground hover:text-background transition-all duration-300 transform hover:scale-110 shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:shadow-[0_0_15px_rgba(255,255,255,0.05)] text-foreground"><span className="text-[10px] font-bold uppercase tracking-widest">fb</span></a>
          </div>
        </div>
        ...
        <div ref={aboutContentRef} className="absolute inset-0 z-10 opacity-0 pointer-events-none flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:px-24 text-right items-end">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[4.5rem] font-light text-foreground max-w-5xl leading-[1.1] tracking-tight select-none mb-4 md:mb-6">
            <span className="about-title-line block">Elevating </span>
            <span className="about-title-line block text-foreground/40">Brands</span>
          </h2>
          <p className="mt-6 md:mt-10 text-foreground/60 max-w-xl md:max-w-3xl text-sm md:text-lg lg:text-xl leading-relaxed font-light lowercase pl-4 about-description">
            Founded on the belief that technology should make work easier, safer, and
            more meaningful.
          </p>
          <div className="mt-10 md:mt-14 lg:mt-16 flex flex-wrap justify-end gap-10 sm:gap-12 md:gap-16 lg:gap-24">
            ...
            <div className="text-right group">
              <p className="font-moonwalk text-4xl md:text-5xl lg:text-7xl text-foreground">100<span className="text-lime text-2xl md:text-3xl lg:text-5xl align-top">+</span></p>
              <p className="text-[8px] md:text-[9px] text-foreground/50 uppercase tracking-[0.3em] md:tracking-[0.4em] mt-2 md:mt-3 lg:mt-4 font-bold">TRUSTED PARTNERSHIPS</p>
            </div>

            <div className="text-right group">
              <p className="font-moonwalk text-4xl md:text-5xl lg:text-7xl text-foreground">10<span className="text-lime text-2xl md:text-3xl lg:text-5xl align-top">+</span></p>
              <p className="text-[8px] md:text-[9px] text-foreground/50 uppercase tracking-[0.3em] md:tracking-[0.4em] mt-2 md:mt-3 lg:mt-4 font-bold">YEARS EXPERIENCE</p>
            </div>
          </div>
        </div>
